...
public class BootAutostart extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            builder.setMinimumLatency(1000 * 60 * 10); // Set to execute after at least 10 minutes delay, in milliseconds
            builder.setOverrideDeadline(1000 * 60 * 60); // The setting is delayed by 1 hour, in milliseconds
